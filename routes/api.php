...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::delete('users/{user}/permissions', [UsersPermissionsController::class, 'revoke'])
        ->name('api.users.permissions.revoke');
    Route::post('users/{user}/assign-permissions', [UsersPermissionsController::class, 'attach'])
    ...
    Route::post('groups/{group}/attach-users', [GroupsUsersController::class, 'attach'])
        ->name('api.groups.users.attach');
    Route::delete('groups/permissions', [GroupsPermissionsController::class, 'revoke'])
        ->name('api.delete.groups.permissions');
    Route::delete('groups/users', [GroupsUsersController::class, 'remove'])
