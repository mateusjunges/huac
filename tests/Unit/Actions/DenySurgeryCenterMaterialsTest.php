...
use HUAC\Actions\DenySurgeryCenterMaterials as DenySurgeryCenterMaterialsAction;
...
class DenySurgeryCenterMaterialsTest extends TestCase
{
    public function test_it_can_deny_surgery_center_materials()
    {
        ...
        $this->assertInstanceOf(
            Log::class,
            DenySurgeryCenterMaterialsAction::execute(
                $this->surgery,
                'Test action'
            )
        );
