...
class CreateUsersTrigger extends Migration
{
    ...
    public function down()
    {
        ...
        DB::statement("DROP PROCEDURE IF EXISTS verify_users_constraints_for_update()");
        DB::statement("DROP TRIGGER IF EXISTS verify_users_constraints_before_update ON users");
    }
}
